...
public class JcrSearchDriver extends SearchService {
  ...
  private static String replaceSpecialCharacters(String query){
    String chars = initParams.get("exo.search.excluded-characters").toString();
    return query.replaceAll("\\" + chars, " ");
  }
}
